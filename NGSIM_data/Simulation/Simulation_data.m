...
rho_0 = interp1(x_ic , rho0_ic, x, 'linear', 'extrap'); 
...
title('R˝chlosù (3D)', 'Interpreter', 'none', 'FontName', 'Arial')
colormap(gca, cmap_plazma)
cb = colorbar;
ylabel(cb, 'R˝chlosù', 'Interpreter', 'none')
...
xlabel('$t$ (PDT)', 'Interpreter', 'latex')
ylabel('$x$ (m)', 'Interpreter', 'latex')
title('R˝chlosù', 'Interpreter', 'none', 'FontName', 'Arial')
colormap(gca, cmap_plazma)
cb = colorbar;
ylabel(cb, 'R˝chlosù', 'Interpreter', 'none')
xticks([0 10 20 30])
...
exportgraphics(fig1, 'NGSIM_simulation.pdf', ...
    'ContentType', 'image', ...
    'Resolution', 600)